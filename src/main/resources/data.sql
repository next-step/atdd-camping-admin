...
values
  ...
  (13, '박석희', DATEADD('DAY', -2, current_date), DATEADD('DAY', -1, current_date), 1, '010-6767-8989', 'WAITING', DATEADD('DAY', -3, current_date), 'R00013', DATEADD('DAY', -3, current_timestamp));
