Feature: 예약 상태 변경
  ...
  # ───────────────────────────────────────
  # 예외: 유효하지 않은 상태 값
  # TODO: ReservationAdminController — status 값을 ReservationStatus enum으로 검증,
  #       유효하지 않으면 400 반환 + 오류 메시지 포함
  # ───────────────────────────────────────
  ...
  # ───────────────────────────────────────
  # 예외: 빈 값 / null 처리
  # TODO: ReservationAdminController — status null/blank 시 400 반환
  # ───────────────────────────────────────
  ...
  # Scenario: status 값을 null로 보내면 실패한다
  #   When null 값으로 상태 변경을 시도한다
  #   Then 상태 변경이 거부된다

  # ───────────────────────────────────────
  # 예외: 허용되지 않는 상태 전이
  # TODO: ReservationAdminController — 상태 전이 규칙 구현 (허용되지 않는 전이 → 400)
  #       허용 전이: CONFIRMED→CHECKED_IN, CHECKED_IN→CHECKED_OUT
  # ───────────────────────────────────────
